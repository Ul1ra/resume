  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a target="_blank" href="https://www.linkedin.com/in/benpetercunningham/"><LinkedinLogo className="w-16 h-16 invert"/></a>
        <a target="_blank" href="https://github.com/Ul1ra?tab=repositories"><GithubLogo className="w-16 h-16 invert"/></a>
        </div>
    </footer>
  )
}
